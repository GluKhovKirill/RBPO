...
def uid_generator():
    ...
    for data in all_data:
        ...
        mess = f"""
{data[2]} {data[3]}, напоминаем Вам, что 11 апреля пройдет третий день цикла лекций по фундаментальным информационным технологиям, их развитию в России и в мире «Школа фундаментальных технологий РБПО»
...
️️❗«Контейнеризация и виртуализация - вчера, сегодня, завтра». 
⏲14:00 - 16:00
👥Спикер: Александр Александрович Дубинин, эксперт по информационной безопасности "YADRO".

❗️Кофе-брейк: 16:00-16:30

️️❗«Построение высоконагруженных сред с применением виртуальной инфраструктуры». 
⏲16:30 - 18:30
👥Спикеры: Дмитрий Анатольевич Сорокин, технический директор ООО "Базис"

Александр Васильевич Иванин, руководитель отдела архитектурных решений ООО "Базис"

Натали Дмитриевна Дуботолкова, старший инженер по РБПО ООО "Базис"
