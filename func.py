...
def uid_generator():
    ...
    for data in all_data:
        ...
        mess = f"""
{data[2]} {data[3]}, напоминаем Вам, что 27 марта пройдет второй день цикла лекций по фундаментальным информационным технологиям, их развитию в России и в мире «Школа фундаментальных технологий РБПО»
...
⏲13:00 - 15:00
👥Спикер: Иван Панченко, заместитель генерального директора "Postgres Professional".
